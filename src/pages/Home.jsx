    ...
    <>
      <nav className="h-[10vh] w-full flex justify-between p-10 border-b border-zinc-800">
        <div className="flex items-center">
          <img
            className="w-10 h-10 bg-zinc-800 p-2 md:mr-2 rounded-md"
            src="/images/web_logo.png"
            alt="logo"
          />
          <h2 className="font-light text-2xl">
            <Link to="/">Linkify</Link>
          </h2>
        </div>

        <div className="flex items-center">
          <ul className="flex gap-10 font-light">
            <li className="border-b hover:border-gray-500 cursor-pointer transition duration-300 ease-in-out">
              Home
            </li>
            <li className="feature-section-button border-b hover:border-gray-500 cursor-pointer transition duration-300 ease-in-out">
              Features
            </li>
            <li className="about-section-button border-b hover:border-gray-500 cursor-pointer transition duration-300 ease-in-out">
              About
            </li>
          </ul>
        </div>
